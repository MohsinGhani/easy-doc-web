...
const BecomeDoctorTemplate = () => {
  return (
    <div className="w-full px-4 md:px-8 lg:px-16 flex justify-center align-middle mt-20">
      <div className="w-full lg:w-[90%] rounded-3xl md:h-96 h-full bg-primary flex flex-col lg:flex-row justify-around items-center lg:items-start py-10">
        ...
        <div className="relative w-[90%] lg:w-[50%] h-[300] lg:h-[400px] mt-10 lg:mt-0 hidden xl:block lg:hidden ">
          <Image
            src="/assets/images/Doctors.png"
            width={600}
            height={600}
            alt="Doctors-img"
            className="absolute top-0 left-1/2 transform -translate-x-1/2 xl:-top-16 lg:left-[55%]"
          />
        </div>
      </div>
    </div>
