...
const AppointmentSection = () => (
  <div className="absolute inset-0 left-1/2 -translate-x-1/2 top-0 flex flex-col items-center justify-center w-full min-h-[500px] md:min-h-[700px]">
    <div className="absolute overflow-hidden w-[90%] sm:w-[70%] h-[30%] sm:h-[53%] xl:h-[60%] -bottom-24 left-1/2 transform -translate-x-1/2 bg-primary rounded-tl-full rounded-tr-full -z-[1] md:bottom-0" />
    ...
    <Card className="relative w-full lg:w-[70%] xl:w-[70%] bg-white items-center justify-center hidden md:block z-30 md:-bottom-96 xl:-bottom-96 rounded-full md:flex">
      <CardContent className="flex items-center justify-between flex-wrap gap-5 w-full">
        <div className="flex items-center xl:gap-8 lg:ml-12">
          ...
          <div className="w-40">
            <div className="text-[#909090] pb-2">Location</div>
          ...
          <div className="h-12 w-px bg-gray-300 sm:hidden md:block"></div>
          ...
          <div className="flex items-center gap-6">
            ...
            <div>
              <Button className={cn(buttonVariants({ size: "xl" }), "rounded-full font-bold mt-3")}>
                Search
              </Button>
            </div>
          </div>
