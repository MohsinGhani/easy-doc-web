  ...
  return (
    <div className="w-full bg-[#f5f8ff] rounded-lg space-y-4 p-4">
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="flex items-center gap-2 justify-between">
            ...
            <div className="flex gap-1">
              ...
              <p className="text-xs font-normal leading-tight">New York, USA</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between gap-6">
        ...
        <Separator orientation="vertical" className="h-10 w-px bg-[#e2e8f0]" />
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center justify-between gap-5">
          ...
          <Separator orientation="vertical" className="h-4 w-px bg-[#e2e8f0]" />
